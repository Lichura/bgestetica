...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { apellido: @medico.apellido, mail: @medico.mail, nombre: @medico.nombre, telefono: @medico.telefono }
    end
  ...
  test "should update medico" do
    patch :update, id: @medico, medico: { apellido: @medico.apellido, mail: @medico.mail, nombre: @medico.nombre, telefono: @medico.telefono }
    assert_redirected_to medico_path(assigns(:medico))
  end
