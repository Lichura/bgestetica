...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { activo: @equipo.activo, descripcion: @equipo.descripcion, nombre: @equipo.nombre }
    end
  ...
  test "should update equipo" do
    patch :update, id: @equipo, equipo: { activo: @equipo.activo, descripcion: @equipo.descripcion, nombre: @equipo.nombre }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
